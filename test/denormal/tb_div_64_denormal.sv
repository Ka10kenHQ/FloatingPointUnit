...
initial begin
    ...
    input_path  = $sformatf("%s/ieee754_test_suite/decomposed_f64_denormal.txt", BASE_PATH);
    output_path = $sformatf("%s/test/outputs/denormal/mul_div_output_results_64_div_denormal.txt", BASE_PATH);
