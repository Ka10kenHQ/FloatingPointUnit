...
initial begin
    ...
    fd_in = $fopen("/home/Zura/FloatingPointUnit/ieee754_test_suite/decomposed_f64_denormal.txt", "r");
    fd_out = $fopen("/home/Zura/FloatingPointUnit/test/mul_div_output_results_64_div_denormal.txt", "w");
