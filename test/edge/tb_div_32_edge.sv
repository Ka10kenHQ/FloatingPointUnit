...
initial begin
    ...
    input_path  = $sformatf("%s/ieee754_test_suite/decomposed_f32_edge.txt", BASE_PATH);
    output_path = $sformatf("%s/test/outputs/edge/mul_div_output_results_32_div_edge.txt", BASE_PATH);
