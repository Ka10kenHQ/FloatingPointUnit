...
initial begin
    ...
    input_path  = $sformatf("%s/ieee754_test_suite/decomposed_f64_edge.txt", BASE_PATH);
    output_path = $sformatf("%s/test/outputs/edge/add_sub_output_results_64_sub_edge.txt", BASE_PATH);
